...
// Convert UNIX timestamp to "X days/hours/minutes ago" format
...
// Get date range from today to 'days' ago in YYYY-MM-DD format
...
// Format raw news article to MarketNewsArticle
...
// Format change percent with + or - sign and two decimals
...
// Get CSS class for change percent (green for positive, red for negative)
...
// Formatted string for today's date like "Monday, January 1, 2024"
